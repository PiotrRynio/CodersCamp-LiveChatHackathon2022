export const verifyTwittQuestionsListMock = [
  {
    question:
      'Czy zdjęcie profilowe użytkownika najprawdopodobniej nie należy do niego? Czy można je znaleźć na popularnych wyszukiwarkach obrazów, np. twinEye?',
    id: '1',
  },
  {
